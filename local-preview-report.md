...
- CSS references checked: 40
- JS references checked: 40
- Asset references checked: 120
- Internal links checked: 1418
- Pages with mobile menu markup and local JS: 40
- Calculator pages with local JS: 5
